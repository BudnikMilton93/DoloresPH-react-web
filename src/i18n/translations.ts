...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    contact: {
      ...
      title: 'Hablemos',
      description:
        'Me encantaría escuchar sobre tu proyecto. Ya sea una boda, sesión de retratos o colaboración creativa — creemos algo hermoso juntos.',
  ...
  pt: {
    ...
    contact: {
      ...
      description:
        'Adoraria ouvir sobre o seu projeto. Seja um casamento, sessão de retratos ou colaboração criativa — vamos criar algo lindo juntos.',
